...
function setMap(){
    ...
    var promises = [];
    promises.push(d3.csv("data/uk_population.csv")); //load attributes from csv
    promises.push(d3.json("data/EuropeCountries.topojson")); //load background spatial data
    promises.push(d3.json("data/Map_UK.topojson")); //load choropleth spatial data
...
function callback(data){
        ...
        var europeCountries = topojson.feature(europe, europe.objects.EuropeCountries),
            ukRegions = topojson.feature(uk, uk.objects.UKRegions).features;
